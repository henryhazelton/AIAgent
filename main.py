...
def generate_content(client, messages):
    ...
    generated_text, prompt_tokens, response_tokens = response.text, f"Prompt tokens: {response.usage_metadata.prompt_token_count}", f"Response tokens: {response.usage_metadata.candidates_token_count}"
